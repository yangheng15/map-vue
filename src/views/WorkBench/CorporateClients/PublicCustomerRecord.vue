  ...
  <div class="FarmersInformation">
    ...
    <div v-if="typeCN == '对公客户建档'">
      ...
      <div v-show="tabId === 1" class="household_have">
        ...
        <van-field name="radio" label="支付工具：">
          <template #input>
            <van-radio-group
        ...
        <van-field name="radio" label="手机银行：">
          <template #input>
            <van-radio-group
